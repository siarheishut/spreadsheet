...
std::any FormulaParser::MainContext::accept(tree::ParseTreeVisitor *visitor) {
...
std::any FormulaParser::UnaryOpContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<FormulaVisitor*>(visitor))
...
std::any FormulaParser::ParensContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<FormulaVisitor*>(visitor))
...
std::any FormulaParser::LiteralContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<FormulaVisitor*>(visitor))
...
std::any FormulaParser::CellContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<FormulaVisitor*>(visitor))
...
std::any FormulaParser::BinaryOpContext::accept(tree::ParseTreeVisitor *visitor) {
  if (auto parserVisitor = dynamic_cast<FormulaVisitor*>(visitor))
